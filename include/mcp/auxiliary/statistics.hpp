...
public:
    ...
    nlohmann::json asJson() {
        return nlohmann::json{{"min", min},  {"max", max}, {"mean", mean}, {"median", median}, {"standard_dev", stdDev},
                              {"mode", mode}};
    }
...
void printGraphInformation(const NetworKit::Graph &g, std::ostream &out = std::cout, bool fast = true);

nlohmann::ordered_json graphMetricsJson(const NetworKit::Graph &g, bool fast = true);
